...
public class Main {
	...
	public static void main(String[] args) {
		...
		MicroProcesador c1 = new MicroProcesador("C-0", "2", (float)123.4, 5, "Intel", "i9", "Wi-Fi", (float)230.2);
		RAM r1 = new RAM("C-0", "3", (float)987.6, 4,"IDK", "DDR", (float)32.1, "Rapida");
		TarjetaMadre t1 = new TarjetaMadre("C-0", "4", (float)123.4, 6, "MSI", "idek", "no se", "rand range", new ArrayList<String>());
		...
		Empresa.getInstance().insertarComponente(c1);
		Empresa.getInstance().insertarComponente(r1);
		Empresa.getInstance().insertarComponente(t1);
